...
- The server does not return `429` or `503` when busy. Concurrent requests are queued and served as capacity frees up. See [Concurrency and Throughput](./concurrency-and-throughput.md).
